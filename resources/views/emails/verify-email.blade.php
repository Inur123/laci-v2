            ...
            <table width="600" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="background:#2563eb;padding:36px 30px;text-align:center;">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&size=96&background=2563eb&color=ffffff&bold=true"
                             style="width:88px;height:88px;border-radius:50%;border:3px solid #fff;margin-bottom:12px;">
                ...
                <tr>
                    <td align="center" style="padding:26px 30px 0;">
                        <div style="display:inline-block;background:#dbeafe;padding:12px 28px;border-radius:999px;border:2px solid #2563eb;">
                ...
                <tr>
                    <td style="padding:26px 40px 22px;">
                        ...
                        <div style="background:#eef2ff;border-left:6px solid #2563eb;padding:14px;border-radius:8px;margin-bottom:12px;">
