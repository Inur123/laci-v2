    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow p-4 sm:p-6">
                ...
                <!-- Event Card Preview -->
                <div class="mb-6 border-l-4 p-4 rounded-r" style="border-color: {{ $kegiatan->warna }}; background-color: {{ $kegiatan->warna }}20;">
                    <div class="flex items-start justify-between mb-2">
                        @if($kegiatan->isOngoing())
                            <span class="px-2 py-1 bg-green-100 text-green-600 rounded text-xs font-medium">Sedang Berlangsung</span>
                        @elseif($kegiatan->isPast())
                            <span class="px-2 py-1 bg-gray-100 text-gray-600 rounded text-xs font-medium">Selesai</span>
                        @else
                            <span class="px-2 py-1 bg-yellow-100 text-yellow-600 rounded text-xs font-medium">Mendatang</span>
                        @endif
                ...
                <div class="space-y-3 sm:space-y-4">
                    <div>
                        ...
                        <p class="text-sm sm:text-base text-gray-800 mt-1 whitespace-pre-wrap break-words">{{ $kegiatan->deskripsi ?? '-' }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm sm:text-base text-gray-800 mt-1">{{ $kegiatan->created_at->format('d F Y, H:i') }} WIB</p>
                    </div>
                </div>
            </div>
        </div>
