        ...
        <tr class="hover:bg-gray-50 transition-colors">
            ...
            <td class="py-3 px-4 whitespace-nowrap">
                <div class="flex items-center gap-3">
                    <img src="{{ $anggota->avatar_url }}" class="w-10 h-10 rounded-full object-cover" alt="{{ $anggota->nama_lengkap }}">
            ...
            <td class="py-3 px-4 whitespace-nowrap">
                <div class="flex items-center gap-2">
                    <button wire:click="detail('{{ $anggota->id }}')" class="text-blue-600 hover:text-blue-800 transition" title="Detail">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button wire:click="edit('{{ $anggota->id }}')" class="text-yellow-600 hover:text-yellow-800 transition" title="Edit">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button onclick="confirmDeleteAnggota('{{ $anggota->id }}', '{{ $anggota->nama_lengkap }}')" class="text-red-600 hover:text-red-800 transition" title="Hapus">
