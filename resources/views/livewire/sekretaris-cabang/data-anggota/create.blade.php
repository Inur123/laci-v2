<!-- filepath: /Users/muhammadzainurroziqin/Documents/coding/ipnu/laci-v2/resources/views/livewire/sekretaris-cabang/data-anggota/create.blade.php -->
<div>
    <!-- Header -->
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Tambah Anggota Baru</h1>
            <p class="text-sm text-gray-600 mt-1">Tambahkan data anggota baru</p>
        </div>
    </div>
    ...
    <div class="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-800">
                ...
                <p>Semua data anggota akan dienkripsi secara otomatis untuk menjaga keamanan dan privasi.</p>
            </div>
        </div>
    </div>
</div>
