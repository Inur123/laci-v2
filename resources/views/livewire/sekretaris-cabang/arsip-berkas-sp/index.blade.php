            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider hidden md:table-cell">Periode</th>
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider hidden sm:table-cell">Tanggal Mulai</th>
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider hidden sm:table-cell">Tanggal Berakhir</th>
                    ...
                    @forelse($berkasList as $index => $berkas)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-700 hidden sm:table-cell whitespace-nowrap">
                                {{ $berkas->tanggal_mulai?->format('d M Y') ?? '-' }}
                            </td>
                            <td class="px-4 py-3 text-sm text-gray-700 hidden sm:table-cell whitespace-nowrap">
                                {{ $berkas->tanggal_berakhir?->format('d M Y') ?? '-' }}
                            </td>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs text-green-600 font-medium mb-1">Tanggal Mulai</p>
                                    <p class="font-semibold text-gray-800">{{ $selectedBerkas->tanggal_mulai?->format('d F Y') ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 border border-orange-200">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs text-orange-600 font-medium mb-1">Tanggal Berakhir</p>
                                    <p class="font-semibold text-gray-800">{{ $selectedBerkas->tanggal_berakhir?->format('d F Y') ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
...
<script>
    function confirmDelete(id, nama) {
        Swal.fire({
            title: 'Hapus Berkas?',
            html: `Berkas <strong>${nama}</strong> akan dihapus secara permanen!`,
            icon: 'warning',
