<div>
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Arsip Berkas Cabang</h1>
        <p class="text-sm text-gray-600 mt-1">Kelola dan lihat arsip berkas cabang</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 text-sm">Total Berkas Cabang</p>
    ...
    <h3 class="text-sm sm:text-base font-semibold text-gray-800">
        Daftar Arsip Berkas Cabang
    </h3>
    <span class="text-[10px] px-2 py-0.5 bg-green-100 text-green-700 rounded-full">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-12 text-center text-gray-500">
                                ...
                                <p class="text-base">Belum ada data berkas cabang</p>
                                @if ($search)
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-full sm:max-w-2xl md:max-w-3xl h-[95vh] sm:h-auto sm:max-h-[90vh] flex flex-col overflow-hidden"
                ...
                <div class="sticky top-0 bg-gradient-to-r from-purple-600 to-purple-700 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between flex-shrink-0 shadow-lg">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl sm:text-2xl font-bold text-white">Detail Berkas Cabang</h3>
                ...
                <div class="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Nama Berkas -->
                        <div class="md:col-span-2 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                            <div class="flex items-start gap-3">
                                <div class="bg-blue-500 p-2 rounded-lg">
                                    <i class="fas fa-folder text-white text-sm"></i>
                                </div>
                                <div class="flex-1">
                                    <p class="text-xs text-blue-600 font-medium mb-1">Nama Berkas</p>
