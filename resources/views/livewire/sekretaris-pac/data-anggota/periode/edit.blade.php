<!-- filepath: resources/views/livewire/sekretaris-pac/data-anggota/periode/edit.blade.php -->
<div>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Periode</h1>
        <p class="text-sm text-gray-600 mt-1">Ubah data periode kepengurusan</p>
    </div>
