...
class ArsipBerkasCabang extends Model
{
    use HasFactory, HasUuids;

    protected $table = 'arsip_berkas_cabang';
    ...
    public static function encryptAndStoreFile($file)
    {
        try {
            ...
            Storage::disk('local')->put('arsip_berkas_cabang/' . $filename, $encrypted);
            return 'arsip_berkas_cabang/' . $filename;
        } catch (\Exception $e) {
